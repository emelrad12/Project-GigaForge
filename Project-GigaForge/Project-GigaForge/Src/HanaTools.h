...
//
// template <typename T>
// auto generateCase_ = [](EntityManager& manager)
// {
// 	auto name = typeid(T).name();
// 	ComponentArray<T> componentArray = std::any_cast<ComponentArray<T>>(manager.data[name]);
// 	return case_<T>([componentArray](auto item, int index)
// 	{
